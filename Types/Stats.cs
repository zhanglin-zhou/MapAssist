...
namespace MapAssist.Types
{
    ...
    {
        public static Dictionary<State, string> BuffNames = new Dictionary<State, string>
        {
            {State.STATE_POISON, "Poison"},
            {State.STATE_RESISTFIRE, "Resist Fire"},
            {State.STATE_RESISTCOLD, "Resist Cold"},
            {State.STATE_RESISTLIGHTNING, "Resist Lightning"},
            {State.STATE_AMPLIFYDAMAGE, "Amplify Damage"},
            {State.STATE_FROZENARMOR, "Frozen Armor"},
            {State.STATE_COLD, "Frozen"},
            {State.STATE_INFERNO, "Inferno"},
            {State.STATE_BLAZE, "Blaze"},
            {State.STATE_BONEARMOR, "Bone Armor"},
            {State.STATE_ENCHANT, "Enchant"},
            {State.STATE_INNERSIGHT, "Inner Sight"},
            {State.STATE_WEAKEN, "Weaken"},
            {State.STATE_CHILLINGARMOR, "Chilling Armor"},
            {State.STATE_DIMVISION, "Dim Vision"},
            {State.STATE_SLOWED, "Slowed"},
            {State.STATE_SHOUT, "Shout"},
            {State.STATE_CONVICTION, "Conviction"},
            {State.STATE_CRITICALSTRIKE, "Critical Strike"},
            {State.STATE_CONVICTED, "Convicted"},
            {State.STATE_ENERGYSHIELD, "Energy Shield"},
            {State.STATE_VENOMCLAWS, "Venom Claws"},
            {State.STATE_BATTLEORDERS, "Battle Orders"},
            {State.STATE_MIGHT, "Might"},
            {State.STATE_PRAYER, "Prayer"},
            {State.STATE_HOLYFIRE, "Holy Fire"},
            {State.STATE_THORNS, "Thorns"},
            {State.STATE_DEFIANCE, "Defiance"},
            {State.STATE_THUNDERSTORM, "Thunder Storm"},
            {State.STATE_BLESSEDAIM, "Blessed Aim"},
            {State.STATE_STAMINA, "Stamina"},
            {State.STATE_CONCENTRATION, "Concentration"},
            {State.STATE_HOLYWIND, "Holy Wind"},
            {State.STATE_CLEANSING, "Cleansing"},
            {State.STATE_HOLYSHOCK, "Holy Shock"},
            {State.STATE_SANCTUARY, "Sanctuary"},
            {State.STATE_MEDITATION, "Meditation"},
            {State.STATE_FANATICISM, "Fanaticism"},
            {State.STATE_REDEMPTION, "Redemption"},
            {State.STATE_BATTLECOMMAND, "Battle Command"},
            {State.STATE_CONVERSION, "Conversion"},
            {State.STATE_IRONMAIDEN, "Iron Maiden"},
            {State.STATE_TERROR, "Terror"},
            {State.STATE_ATTRACT, "Attract"},
            {State.STATE_LIFETAP, "Life Tap"},
            {State.STATE_CONFUSE, "Confuse"},
            {State.STATE_DECREPIFY, "Decrepify"},
            {State.STATE_LOWERRESIST, "Lower Resist"},
            {State.STATE_CYCLONEARMOR, "Cyclone Armor"},
            {State.STATE_DODGE, "Dodge"},
            {State.STATE_AVOID, "Avoid"},
            {State.STATE_PENETRATE, "Penetrate"},
            {State.STATE_EVADE, "Evade"},
            {State.STATE_PIERCE, "Pierce"},
            {State.STATE_WARMTH, "Warmth"},
            {State.STATE_FIREMASTERY, "Fire Mastery"},
            {State.STATE_LIGHTNINGMASTERY, "Lightning Mastery"},
            {State.STATE_COLDMASTERY, "Cold Mastery"},
            {State.STATE_BLADEMASTERY, "Blade Mastery"},
            {State.STATE_AXEMASTERY, "Axe Mastery"},
            {State.STATE_MACEMASTERY, "Mace Mastery"},
            {State.STATE_POLEARMMASTERY, "Polearm Mastery"},
            {State.STATE_THROWINGMASTERY, "Throwing Mastery"},
            {State.STATE_SPEARMASTERY, "Spear Mastery"},
            {State.STATE_INCREASEDSTAMINA, "Increased Stamina"},
            {State.STATE_IRONSKIN, "Iron Skin"},
            {State.STATE_INCREASEDSPEED, "Increased Speed"},
            {State.STATE_NATURALRESISTANCE, "Natural Resistance"},
            {State.STATE_SLOWMISSILES, "Slow Missiles"},
            {State.STATE_SHIVERARMOR, "Shiver Armor"},
            {State.STATE_VALKYRIE, "Valkyrie"},
            {State.STATE_FRENZY, "Frenzy"},
            {State.STATE_BERSERK, "Berserk"},
            {State.STATE_HOLYSHIELD, "Holy Shield"},
            {State.STATE_DEFENSE_CURSE, "Defense Curse"},
            {State.STATE_BLOOD_MANA, "Blood Mana"},
            {State.STATE_SHADOWWARRIOR, "Shadow Master"},
            {State.STATE_FERALRAGE, "Feral Rage"},
            {State.STATE_TIGERSTRIKE, "Tiger Strike"},
            {State.STATE_COBRASTRIKE, "Cobra Strike"},
            {State.STATE_PHOENIXSTRIKE, "Phoenix Strike"},
            {State.STATE_FISTSOFFIRE, "Fists Of Fire"},
            {State.STATE_BLADESOFICE, "Blades Of Ice"},
            {State.STATE_CLAWSOFTHUNDER, "Claws Of Thunder"},
            {State.STATE_FENRIS_RAGE, "Fenris Rage"},
            {State.STATE_WOLF, "Wolf"},
            {State.STATE_BEAR, "Bear"},
            {State.STATE_HURRICANE, "Hurricane"},
            {State.STATE_ARMAGEDDON, "Armageddon"},
            {State.STATE_BARBS, "Barbs"},
            {State.STATE_WOLVERINE, "Wolverine"},
            {State.STATE_OAKSAGE, "Oak Sage"},
            {State.STATE_CLAWMASTERY, "Claw Mastery"},
            {State.STATE_CLOAK_OF_SHADOWS, "Cloakof Shadows"},
            {State.STATE_WEAPONBLOCK, "Weapon Block"},
            {State.STATE_CLOAKED, "Cloaked"},
            {State.STATE_QUICKNESS, "Quickness"},
            {State.STATE_BLADESHIELD, "Blade Shield"},
            {State.STATE_FADE, "Fade"}
        };
    }
